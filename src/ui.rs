...
impl Plugin for UiPlugin {
    fn build(&self, app: &mut App) {
        app
            ...
            .add_system(button_system.label(crate::UpdateStages::UI).before(crate::UpdateStages::Input))
            .add_system(update_performance_text.label(crate::UpdateStages::UI).after(crate::UpdateStages::WorldUpdate))
        ;
    }
}
